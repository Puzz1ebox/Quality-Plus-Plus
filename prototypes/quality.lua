...
data:extend({
    {
		...
		subgroup = "qualities",
		icon = "__Quality+__/graphics/icons/quality-mythical.png",
	...
	},
	{
		...
		next_probability = 0.1,
		subgroup = "qualities",
		icon = "__Quality+__/graphics/icons/quality-masterwork.png",
	...
	},
	{
		...
		subgroup = "qualities",
		icon = "__Quality+__/graphics/icons/quality-wonderous.png",
	...
	},
	{
		...
		next_probability = 0.1,
		subgroup = "qualities",
		icon = "__Quality+__/graphics/icons/quality-artifactual.png",
